...
function gen_bloch_sphere() {
    ...
    // Get text elements with fallback for dashboard integration
    const northTextElement = document.getElementById('north_text');
    const southTextElement = document.getElementById('south_text');

    north_text = northTextElement ? northTextElement.value : "|0⟩";
    south_text = southTextElement ? southTextElement.value : "|1⟩";
